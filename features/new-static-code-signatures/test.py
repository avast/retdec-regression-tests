...
class TestNewARM32Signatures(Test):
    ...
    def test_check_correct_static_functions_detection(self):
        ...
        assert self.out_config.is_statically_linked('__scrt_set_unhandled_exception_filter', 0x4022d4)
        assert self.out_config.is_statically_linked('__scrt_unhandled_exception_filter', 0x4022f0)
        assert self.out_config.is_statically_linked('__isa_available_init', 0x4023b4)
        ...
        assert self.out_config.is_statically_linked('_set_pgmptr', 0x403bb4)
        ...
        #assert self.out_config.is_statically_linked('__sys_nerr', 0x4046c8)
        ...
        assert self.out_config.is_statically_linked('__acrt_unlock', 0x407d20)
        ...
        assert self.out_config.is_statically_linked('__acrt_lowio_unlock_fh', 0x407e94)
        ...
        assert self.out_config.is_statically_linked('__acrt_initialize_heap', 0x40879c)
...
class TestNewx86Signatures(Test):
    ...
    def test_check_correct_static_functions_detection(self):
        ...
        assert self.out_config.is_statically_linked('__RTC_Initialize', 0x4018a5)
        #assert self.out_config.is_statically_linked('__RTC_Terminate', 0x4018d0)
        ...
        assert self.out_config.is_statically_linked('_strtol', 0x405eca)
        assert self.out_config.is_statically_linked('__mbtowc_l', 0x405ef6)
        assert self.out_config.is_statically_linked('_mbtowc', 0x405ff0)
        ...
        assert self.out_config.is_statically_linked('_memcpy_s', 0x4080e3)
        ...
        assert self.out_config.is_statically_linked('__CIlog10', 0x40d380)
        assert self.out_config.is_statically_linked('__CIlog10_default', 0x40d3bb)
        assert self.out_config.is_statically_linked('_ceil', 0x40d490)

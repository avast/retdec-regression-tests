...
class Test(Test):
    ...
    def test_fileinfo_detects_bytecode(self):
        self.assertEqual(self.decomp.fileinfo_output['Original language'], 'CIL/.NET (bytecode)')
    ...
    def test_warning_is_emitted(self):
        ...
        assert self.decomp.log.contains(r'Warning: Detected CIL/.NET bytecode, which .*')

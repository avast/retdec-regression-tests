...
class TestFunctionThroughSections(Test):
    ...
    def test_one_function_is_not_through_several_sections(self):
        ...
        assert self.out_dsm.contains(r'; function: function_80483a0 at 0x80483a0 -- 0x80483a5')
        assert self.out_dsm.contains(r'; function: function_80483d0 at 0x80483d0 -- 0x80483d5')
        assert self.out_dsm.contains(r'0x80483a0:\s*ff 25 e8 98 04 08\s*jmp dword ptr \[0x80498e8\] <printf>')

        assert self.out_dsm.contains(r'; data inside code section at 0x8048390 -- 0x804839f')
    ...
    def test_functions_in_plt(self):
        assert self.out_dsm.contains(r'; function: function_80483a0 at 0x80483a0 -- 0x80483a5')
        assert self.out_dsm.contains(r'; function: function_80483b0 at 0x80483b0 -- 0x80483b5')
        assert self.out_dsm.contains(r'; function: function_80483c0 at 0x80483c0 -- 0x80483c5')
        assert self.out_dsm.contains(r'; function: function_80483d0 at 0x80483d0 -- 0x80483d5')
...
class TestDsm(Test):
    ...
    def test_defined_functions(self):
        ...
        assert self.out_dsm.contains(r'; function: ___tmainCRTStartup at 0x401180 -- 0x4014bb')
        ...
        assert self.out_dsm.contains(r'; function: _naive_ackermann at 0x401560 -- 0x4015f0')
        ...
        assert self.out_dsm.contains(r'; function: _memcpy at 0x407710 -- 0x407715')
        assert self.out_dsm.contains(r'; function: _malloc at 0x407718 -- 0x40771d')
        assert self.out_dsm.contains(r'; function: _strlen at 0x407720 -- 0x407725')
        assert self.out_dsm.contains(r'; function: __cexit at 0x407728 -- 0x40772d')
        assert self.out_dsm.contains(r'; function: __amsg_exit at 0x407730 -- 0x407735')
        assert self.out_dsm.contains(r'; function: __initterm at 0x407738 -- 0x40773d')
        assert self.out_dsm.contains(r'; function: _exit at 0x407740 -- 0x407745')
        assert self.out_dsm.contains(r'; function: _scanf at 0x407748 -- 0x40774d')
        assert self.out_dsm.contains(r'; function: _printf at 0x407750 -- 0x407755')
        assert self.out_dsm.contains(r'; function: __lock at 0x407758 -- 0x40775d')
        assert self.out_dsm.contains(r'; function: ___dllonexit at 0x407760 -- 0x407765')
        assert self.out_dsm.contains(r'; function: __unlock at 0x407768 -- 0x40776d')
        assert self.out_dsm.contains(r'; function: _signal at 0x407770 -- 0x407775')
        assert self.out_dsm.contains(r'; function: ___setusermatherr at 0x407778 -- 0x40777d')
        assert self.out_dsm.contains(r'; function: _abort at 0x407780 -- 0x407785')
        assert self.out_dsm.contains(r'; function: _strncmp at 0x407788 -- 0x40778d')
        assert self.out_dsm.contains(r'; function: _calloc at 0x407790 -- 0x407795')
        assert self.out_dsm.contains(r'; function: _free at 0x407798 -- 0x40779d')
        assert self.out_dsm.contains(r'; function: _fputc at 0x4077a0 -- 0x4077a5')
        assert self.out_dsm.contains(r'; function: _localeconv at 0x4077a8 -- 0x4077ad')
        assert self.out_dsm.contains(r'; function: __errno at 0x4077b0 -- 0x4077b5')
        assert self.out_dsm.contains(r'; function: _getenv at 0x4077b8 -- 0x4077bd')
        assert self.out_dsm.contains(r'; function: _strerror at 0x4077c0 -- 0x4077c5')
        assert self.out_dsm.contains(r'; function: _wcslen at 0x4077c8 -- 0x4077cd')
        assert self.out_dsm.contains(r'; function: _setlocale at 0x4077d0 -- 0x4077d5')
        assert self.out_dsm.contains(r'; function: _strchr at 0x4077d8 -- 0x4077dd')
        assert self.out_dsm.contains(r'; function: _atoi at 0x4077e0 -- 0x4077e5')
        assert self.out_dsm.contains(r'; function: _register_frame_ctor at 0x407a40 -- 0x407a58')
    ...
    def test_statically_linked_functions(self):
        ...
        assert self.out_dsm.contains(r'; statically linked function: __InterlockedCompareExchange at 0x4029e0 -- 0x4029f0')

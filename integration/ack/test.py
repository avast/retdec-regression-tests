...
class Test_2015_Pic32GccElf(TestBase):
    ...
    def test_statically_linked_function_detection(self):
        # confirmed functions
        assert self.out_config.is_statically_linked('_dvfprintf_cdnopuxX', 0x9d000020)
        assert self.out_config.is_statically_linked('_vfscanf_cdnopuxX', 0x9d000ad0)
        assert self.out_config.is_statically_linked('_filbuf', 0x9d001bf4)
        assert self.out_config.is_statically_linked('fputc', 0x9d001ff8)
        assert self.out_config.is_statically_linked('read', 0x9d002138)
        assert self.out_config.is_statically_linked('_flsbuf', 0x9d002278)
        assert self.out_config.is_statically_linked('fgetc', 0x9d0023a4)
        assert self.out_config.is_statically_linked('_general_exception_context', 0x9d0025b0)
        assert self.out_config.is_statically_linked('_mon_putc', 0x9d002750)
        ...
        assert self.out_config.is_statically_linked('_DefaultInterrupt', 0x9d002b1c)
        assert self.out_config.is_statically_linked('_printf_cdnopuxX', 0x9d002b64)
        assert self.out_config.is_statically_linked('_scanf_cdnopuxX', 0x9d002ba4)
        ...
        # leftovers - unconfirmed
        assert not self.out_config.is_statically_linked('_nmi_handler', 0x9d002c88)
...
class Test_2015_MipsGccElf(TestBase):
    ...
    def test_statically_linked_function_detection(self):
        ...
        assert self.out_config.is_statically_linked('__getreent', 0x89075b4)
        ...
        assert self.out_config.is_statically_linked('__fp_unlock_all', 0x89078c4)
        ...
        assert self.out_config.is_statically_linked('localeconv', 0x8908520)
        ...
        assert self.out_config.is_statically_linked('__psp_safe_strcpy', 0x890e668)
        ...
        assert self.out_config.is_statically_linked('__locale_charset', 0x891371c)
        ...
        assert self.out_config.is_statically_linked('__ledf2', 0x8914ee4)
        assert self.out_config.is_statically_linked('__ledf2', 0x8914f74)
        assert self.out_config.is_statically_linked('__gedf2', 0x8915004)
        assert self.out_config.is_statically_linked('__gedf2', 0x8915088)
        assert self.out_config.is_statically_linked('__ledf2', 0x891510c)

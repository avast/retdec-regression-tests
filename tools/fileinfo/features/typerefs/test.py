...
class TestTypeRefNested(Test):
    ...
    def test_correctly_analyzes_typerefs_nested(self):
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][0]['nameSpace'], 'System.Runtime.CompilerServices')
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][1]['nameSpace'], 'System.Runtime.CompilerServices')
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][2]['nameSpace'], 'System.Diagnostics')
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][3]['nameSpace'], 'System.Diagnostics')
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][4]['nameSpace'], 'System.Runtime.Versioning')
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][5]['nameSpace'], 'System.Reflection')
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][6]['nameSpace'], 'System.Reflection')
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][7]['nameSpace'], 'System.Reflection')
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][8]['nameSpace'], 'System.Reflection')
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][9]['nameSpace'], 'System.Reflection')
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][10]['nameSpace'], 'System.Reflection')
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][11]['nameSpace'], 'System')
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][12]['nameSpace'], 'CustomLibrary')
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][13]['nameSpace'], 'CustomLibrary')
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][14]['nameSpace'], 'CustomLibrary')
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][15]['nameSpace'], 'CustomLibrary')
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][16]['nameSpace'], 'CustomLibrary')
        ...
        self.assertEqual(self.fileinfo.output['typeRefTable']['dotnet imported classes'][17]['nameSpace'], 'System')

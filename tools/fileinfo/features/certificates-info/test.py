...
class Test1(Test):
    ...
    def test_certificates(self):
        ...
        assert self.fileinfo.output['certificateTable']['numberOfSignatures'] == 2

        self.assertEqual(
            len(self.fileinfo.output["certificateTable"]['signatures'][0]["allCertificates"]), 5)
        ...
        self.assertEqual(self.fileinfo.output["certificateTable"]['signatures'][0]['signer']['chain'][1]
                         ["sha256"], "582DC1D97A790EF04FE2567B1EC88C26B03BF6E99937CAE6A0B50397AD20BBF8")
        self.assertEqual(self.fileinfo.output["certificateTable"]['signatures'][0]['signer']['chain'][2]
                         ["sha256"], "8420DFBE376F414BF4C0A81E6936D24CCC03F304835B86C7A39142FCA723A689")

        self.assertEqual(self.fileinfo.output["certificateTable"]['signatures'][0]['signer']['counterSigners'][0]['chain'][0]
                         ["sha256"], "0374881C9B74D31F28DC580B0F2B9D2B14A97CE31CBEC2A05AEB377DCDDCC2B0")
        self.assertEqual(self.fileinfo.output["certificateTable"]['signatures'][0]['signer']['counterSigners'][0]['chain'][1]
                         ["sha256"], "0625FEE1A80D7B897A9712249C2F55FF391D6661DBD8B87F9BE6F252D88CED95")

        self.assertEqual(
            len(self.fileinfo.output["certificateTable"]['signatures'][1]["allCertificates"]), 6)
...
class Test2(Test):
    ...
    def test_certificates(self):
        ...
        self.assertEqual(self.fileinfo.output["certificateTable"]['signatures'][1]['signer']['chain'][0]
                         ["sha256"], "3A0682AB7FB478BA82FD11CE4DB9B0ADEA55DA05558A0CF737453D51572163D0")
        self.assertEqual(self.fileinfo.output["certificateTable"]['signatures'][1]['signer']['chain'][1]
                         ["sha256"], "0CFC19DB681B014BFE3F23CB3A78B67208B4E3D8D7B6A7B1807F7CD6ECB2A54E")
        self.assertEqual(self.fileinfo.output["certificateTable"]['signatures'][1]['signer']['chain'][2]
                         ["sha256"], "8420DFBE376F414BF4C0A81E6936D24CCC03F304835B86C7A39142FCA723A689")

        self.assertEqual(self.fileinfo.output["certificateTable"]['signatures'][1]['signer']['counterSigners'][0]['chain'][0]
                         ["sha256"], "43CE166BC567F9887D650A2E624473BE7A43A6F378ABE03CB32FA63F7ABB1E45")
        self.assertEqual(self.fileinfo.output["certificateTable"]['signatures'][1]['signer']['counterSigners'][0]['chain'][1]
                         ["sha256"], "0625FEE1A80D7B897A9712249C2F55FF391D6661DBD8B87F9BE6F252D88CED95")
        self.assertEqual(self.fileinfo.output["certificateTable"]['signatures'][1]['signer']['counterSigners'][0]['chain'][2]
...
class Test3(Test):
    ...
    def test_certificates(self):
        ...
        self.assertEqual(
            self.fileinfo.output["certificateTable"]["numberOfSignatures"], 2)

        self.assertEqual(
            len(self.fileinfo.output["certificateTable"]["signatures"][0]['allCertificates']), 7)
...
class Test4(Test):
    ...
    def test_certificates(self):
        assert self.fileinfo.succeeded
        self.assertEqual(
            self.fileinfo.output["certificateTable"]["numberOfSignatures"], 1)
...
class Test7(Test):
    ...
    def test_certificates(self):
        ...
        self.assertEqual(
            len(self.fileinfo.output["certificateTable"]["signatures"][0]['allCertificates']), 4)
...
class Test11(Test):
    ...
    def test_certificates(self):
        ...
        self.assertEqual(
            len(self.fileinfo.output["certificateTable"]["signatures"][0]['allCertificates']), 3)
...
class Test12(Test):
    ...
    def test(self):
        ...
        assert self.fileinfo.output['certificateTable']['numberOfSignatures'] == 2
        assert len(self.fileinfo.output['certificateTable']['signatures']) == 2

        first_signature = self.fileinfo.output['certificateTable']['signatures'][0]
        ...
        #######################################################################
        second_signature = self.fileinfo.output['certificateTable']['signatures'][1]
